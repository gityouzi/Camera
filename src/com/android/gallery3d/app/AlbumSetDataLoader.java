...
public class AlbumSetDataLoader {
    ...
    private final MediaItem[][] mCoverAddItem;//jiangxd add
    ...
    public AlbumSetDataLoader(AbstractGalleryActivity activity, MediaSet albumSet, int cacheSize) {
        ...
        mCoverAddItem = new MediaItem[cacheSize][3];//jiangxd add
    ...
    //jiangxd add
    public MediaItem[] getCoverAddItem(int index){
    	assertIsActive(index);
    	return mCoverAddItem[index % mCoverAddItem.length];
    }
    //end
    ...
    private void clearSlot(int slotIndex) {
        ...
        mCoverAddItem[slotIndex] = null;//jiangxd add
    ...
    private static class UpdateInfo {
        ...
        public MediaItem[] coverAdded;//jiangxd add
    ...
    private class UpdateContent implements Callable<Void> {
        ...
        public Void call() {
            ...
            if (info.index >= mContentStart && info.index < mContentEnd) {
                ...
                mCoverAddItem[pos] = info.coverAdded;//jiangxd add
        ...
        public void run() {
            ...
            while (mActive) {
                ...
                if (info.index != INDEX_NONE) {
                    ...
                    info.coverAdded = info.item.getCoverAddMediaItem();//jiangxd add
