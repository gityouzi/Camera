...
abstract public class ActivityState  implements IYCServiceCallback{
	...
	public void	onPositionChangedExt(int x,int isEdged){};
    ...
    public void onHandsDetected(boolean isDetected){};
