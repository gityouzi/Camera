...
public final class Gallery extends AbstractGalleryActivity implements OnCancelListener {
    ...
    public void setDockBarVisible(boolean showDockbar){
    }
    public void dockBarHandsDetected(boolean hasHand){
    	
    }
    public void dockBarChangeItem(boolean isNext){
    }
    public void dockBarClickItem(){
    }
    //end
    ...
    public void startDefaultPage() {
        ...
        //jiangxd  modify default cluster by time
        String basePath = getDataManager().getTopSetPath(DataManager.INCLUDE_ALL);
        String newPath = FilterUtils.switchClusterPath(basePath, FilterUtils.CLUSTER_BY_TIME);
