...
public class PhotoView extends GLView {
    ...
    private static final int MSG_FLING_PHOTOVIEW = 9;
    //end
    ...
    public final MyGestureListener mGestureListener;
    ...
    class MyHandler extends SynchronizedHandler {
        ...
        public void handleMessage(Message message) {
            switch (message.what) {
                ...
                //jiangxd add for ycservice
                case MSG_FLING_PHOTOVIEW:
                	mGestureListener.onFling(message.arg1, 0);
                	break;
                //end
...
//          	break;
//          }
//          mHandler.removeMessages(MSG_FLING_PHOTOVIEW);
//          Message m = mHandler.obtainMessage(MSG_FLING_PHOTOVIEW);
//          m.arg1 = velocity;
